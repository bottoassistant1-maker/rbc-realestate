...
"Club de Golf El Campanario · Querétaro · 2025": "Club de Golf El Campanario · Querétaro · 2025",
...
"For sale · Club de Golf El Campanario · Querétaro": "En venta · Club de Golf El Campanario · Querétaro",
...
"Club de Golf El Campanario · Querétaro": "Club de Golf El Campanario · Querétaro",
...
# Travertino
"Newly built on the last lot of its private street, facing the mountains: double-height living and bar, pool with sun deck, three en-suite bedrooms and a flexible en-suite room downstairs.":
 "Recién construida en el último lote de su privada, frente a las montañas: sala y bar en doble altura, alberca con asoleadero, tres recámaras con baño y una habitación flexible con baño en planta baja.",
"Casa Travertino occupies the last lot of its private street inside El Campanario, which is why every terrace looks at the mountains. The ground floor is made for gathering: living room with bar and dining in double height, a kitchen with breakfast area, a covered terrace and a sun deck around the pool. Upstairs, three en-suite bedrooms, a family TV room and a lobby that works as a reading room or linen closet. Newly built; never lived in.":
 "Casa Travertino ocupa el último lote de su privada dentro de El Campanario, por eso todas las terrazas miran a las montañas. La planta baja está hecha para reunirse: sala con bar y comedor en doble altura, cocina con desayunador, terraza techada y asoleadero alrededor de la alberca. Arriba, tres recámaras con baño, sala de TV familiar y un lobby que funciona como sala de lectura o closet de blancos. Recién construida; nunca habitada.",
"Double-height living with bar and dining on the ground floor, terraces to the mountains; three en-suite bedrooms and a family room upstairs; a flexible en-suite room below.":
 "Sala en doble altura con bar y comedor en planta baja, terrazas hacia las montañas; tres recámaras con baño y sala familiar arriba; una habitación flexible con baño abajo.",
"Club de Golf El Campanario, Querétaro — the last lot of its private street, with open mountain views.": "Club de Golf El Campanario, Querétaro — el último lote de su privada, con vistas abiertas a las montañas.",
...
"Three en-suite bedrooms upstairs + family TV room + reading lobby": "Tres recámaras con baño arriba + sala de TV familiar + lobby de lectura",
...
"Garage for 3 cars · staff room with bath and service patio · kitchen with breakfast area · en-suite room (gym / study / bedroom) · living-bar and dining in double height · covered terrace · sun deck and pool · outdoor half-bath · guest half-bath · storage":
 "Cochera para 3 autos · cuarto de servicio con baño y patio de servicio · cocina con desayunador · habitación con baño (gym / estudio / recámara) · sala-bar y comedor en doble altura · terraza techada · asoleadero y alberca · medio baño exterior · medio baño de visitas · bodega",
...
"Last lot of its private street in El Campanario golf club, Querétaro — open mountain views with nothing to be built in front.": "Último lote de su privada en el Club de Golf El Campanario, Querétaro — vistas abiertas a la montaña sin nada por construir enfrente.",
# Magno
...
"Club de Golf El Campanario · Querétaro · Built by RBC": "Club de Golf El Campanario · Querétaro · Construida por RBC",
