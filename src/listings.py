...
add(slug="casa-travertino", page=True, city="qro", kind="sale", name="Casa Travertino", where="Club de Golf El Campanario · Querétaro",
    ...
    specs=[("4","bedrooms"),("Staff","quarters"),("4+2","baths"),("3","cars"),("Pool","& sun deck"),("Double","height")],
    ...
    highlights=["Last lot of its private street — open mountain views","Double-height living room with bar, and dining room","Covered terrace, sun deck and pool with outdoor half-bath","Four en-suite bedrooms + staff quarters","Three bedrooms upstairs with family TV room and reading lobby; a fourth en-suite bedroom on the ground floor (also gym or study)","Kitchen with breakfast area, full staff quarters and service patio, storage","Three-car garage · guest half-bath","Designed and built by RBC"],
