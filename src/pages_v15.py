...
<section id="intro">
  <div class="wrap split" style="align-items:start;">
    ...
    <div class="rv d1">
      ...
      <p class="lead">Each project develops its own architectural language. Larger works are built with Espacios y Formas, the Balderas family's architecture, construction and development firm in Celaya and San Miguel de Allende.</p>
