...
PROJECTS = [
  ...
  dict(slug="casa-travertino", m2="731", scale="art", name="Casa Travertino", place="El Campanario Residencial & Golf · Querétaro", year="2025", cat="res", built=True, sale="casa-travertino.html", img="img/ph-travertino-r02.jpg", photos=['img/ph-travertino-r02.jpg', 'img/ph-travertino-r01.jpg', 'img/ph-travertino-r03.jpg'], ig="C_3mXTMxFYj",
